    ...
    class Unpublish extends Command {
      ...
      promptForConfirmation(packageName, packageVersion, callback) {
        ...
        if (packageVersion) {
          ...
          question = `Are you sure you want to unpublish ALL VERSIONS of '${packageLabel}'? ` + "This will remove it from the ipm registry, including " + "download counts and stars, and this action is irreversible. (no)";
        }
