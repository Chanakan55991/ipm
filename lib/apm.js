(function() {
  ...
  module.exports = {
    ...
    getAtomDirectory: function() {
      var ref;
      return (ref = process.env.ATOM_HOME) != null ? ref : path.join(this.getAppDataPath(), 'inkdrop');
    },
    ...
    getAtomApiUrl: function() {
      var ref;
      return (ref = process.env.ATOM_API_URL) != null ? ref : 'https://www.inkdrop.info/api/v1';
    },
